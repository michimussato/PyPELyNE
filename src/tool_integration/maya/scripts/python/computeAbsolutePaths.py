...
class computeAbsolutePaths():
    ...
    def __init__( self ):
        ...
        self.projectRoot = self.currentWorkspace
        ...
        self.allCacheFileNodes = cmds.ls( type="cacheFile" )
        self.allAiFileNodes = cmds.ls( type="aiImage" )
        ...
        for fileNode in self.allFileNodes:
            ...
            if os.path.isabs( attrValue ):
                try:
                    ...
                    #print relPathPostfix
                    #relPath = self.relPathString = self.relPrefix + os.sep + relPathPostfix
                    relPath = os.path.relpath( attrValue, self.projectRoot )
                    #print relPath
    ...
    def convertAiFileNodeAbsPaths( self ):

        for aiFileNode in self.allAiFileNodes:

            #cmds.listAttr( file1 )

            cmds.select( aiFileNode )

            attrValue = cmds.getAttr( '.filename' )
            ...
            if os.path.isabs( attrValue ):
                try:
                    ...
                    relPath = os.path.relpath( attrValue, self.projectRoot )
                    print "relPath = " + relPath
                    cmds.setAttr( '.filename', relPath , type='string' )
                #mel: setAttr -type "string" file1.fileTextureName "../../../../../../../../Users/michaelmussato/Desktop/desktop/Screen shot 2013-06-05 at 23.01.26.jpg"
                #python: cmds.setAttr( "file1.fileTextureName", "../../../../../../../../Users/michaelmussato/Desktop/desktop/Screen shot 2013-06-05 at 23.01.26.jpg" , type="string" )
                #proj: /Volumes/pili/projects/2014-05-19___myself___doodle/assets/AST_asset01/MDL_MAY__convertAbsoluteTexturePaths/usr/
                except:
        ...
        for referenceNode in self.allReferenceNodes:
            ...
            try:
                ...
                if os.path.isabs( referenceNodePathUnresolved ):
                    ...
                    #relPath = self.relPathString = self.relPrefix + os.sep + relPathPostfix
                    relPath = os.path.relpath( referenceNodePathUnresolved, self.projectRoot )
                    print "relPath = " + relPath
    ...
    def convertCacheFileNodeAbsPaths( self ):

        for cacheFileNode in self.allCacheFileNodes:

            #cmds.listAttr( file1 )

            cmds.select( cacheFileNode )

            attrValue = cmds.getAttr( '.cachePath' )
            ...
            if os.path.isabs( attrValue ):
                try:
                    ...
                    relPath = os.path.relpath( attrValue, self.projectRoot )
                    print "relPath = " + relPath
                    cmds.setAttr( '.cachePath', relPath , type='string' )
                #mel: setAttr -type "string" file1.fileTextureName "../../../../../../../../Users/michaelmussato/Desktop/desktop/Screen shot 2013-06-05 at 23.01.26.jpg"
                #python: cmds.setAttr( "file1.fileTextureName", "../../../../../../../../Users/michaelmussato/Desktop/desktop/Screen shot 2013-06-05 at 23.01.26.jpg" , type="string" )
                #proj: /Volumes/pili/projects/2014-05-19___myself___doodle/assets/AST_asset01/MDL_MAY__convertAbsoluteTexturePaths/usr/
                except:
    ...
    def doItAll( self ):
        self.convertFileNodeAbsPaths()
        self.convertRefNodesAbsPaths()
        self.convertAiFileNodeAbsPaths()
        self.convertCacheFileNodeAbsPaths()
